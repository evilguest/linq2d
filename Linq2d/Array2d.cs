...
///@@@
        public static IArrayTransform2<T, R1, R2> SelectMany<T, _, R1, R2>(this IArrayQueryRecurrent<T, _, R1> source, Func<object, Result<R2>> recurrentSelector, Expression<Func<_, RelativeCell<R2>, (R1, R2)>> resultSelector) 
            => new ArrayQuery2<T, R1, R2>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=1 k=2 l=2 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent2<T, A, R1, R2> SelectMany<T, _, A, R1, R2>(this IArrayQueryRecurrent<T, _, R1> source, Func<object, Result<R2>> secondSelector, Expression<Func<_, RelativeCell<R2>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent2<T, A, R1, R2>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform3<T, R1, R2, R3> SelectMany<T, _, R1, R2, R3>(this IArrayQueryRecurrent2<T, _, R1, R2> source, Func<object, Result<R3>> recurrentSelector, Expression<Func<_, RelativeCell<R3>, (R1, R2, R3)>> resultSelector) 
            => new ArrayQuery3<T, R1, R2, R3>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=1 k=3 l=3 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent3<T, A, R1, R2, R3> SelectMany<T, _, A, R1, R2, R3>(this IArrayQueryRecurrent2<T, _, R1, R2> source, Func<object, Result<R3>> secondSelector, Expression<Func<_, RelativeCell<R3>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent3<T, A, R1, R2, R3>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform4<T, R1, R2, R3, R4> SelectMany<T, _, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T, _, R1, R2, R3> source, Func<object, Result<R4>> recurrentSelector, Expression<Func<_, RelativeCell<R4>, (R1, R2, R3, R4)>> resultSelector) 
            => new ArrayQuery4<T, R1, R2, R3, R4>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=1 k=4 l=4 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent4<T, A, R1, R2, R3, R4> SelectMany<T, _, A, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T, _, R1, R2, R3> source, Func<object, Result<R4>> secondSelector, Expression<Func<_, RelativeCell<R4>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent4<T, A, R1, R2, R3, R4>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        // n=2 k=2 l=2 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent2<T1, T2, A, R1, R2> SelectMany<T1, T2, _, A, R1, R2>(this IArrayQueryRecurrent<T1, T2, _, R1> source, Func<object, Result<R2>> secondSelector, Expression<Func<_, RelativeCell<R2>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent2<T1, T2, A, R1, R2>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform3<T1, T2, R1, R2, R3> SelectMany<T1, T2, _, R1, R2, R3>(this IArrayQueryRecurrent2<T1, T2, _, R1, R2> source, Func<object, Result<R3>> recurrentSelector, Expression<Func<_, RelativeCell<R3>, (R1, R2, R3)>> resultSelector) 
            => new ArrayQuery3<T1, T2, R1, R2, R3>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=2 k=3 l=3 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent3<T1, T2, A, R1, R2, R3> SelectMany<T1, T2, _, A, R1, R2, R3>(this IArrayQueryRecurrent2<T1, T2, _, R1, R2> source, Func<object, Result<R3>> secondSelector, Expression<Func<_, RelativeCell<R3>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent3<T1, T2, A, R1, R2, R3>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform4<T1, T2, R1, R2, R3, R4> SelectMany<T1, T2, _, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T1, T2, _, R1, R2, R3> source, Func<object, Result<R4>> recurrentSelector, Expression<Func<_, RelativeCell<R4>, (R1, R2, R3, R4)>> resultSelector) 
            => new ArrayQuery4<T1, T2, R1, R2, R3, R4>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=2 k=4 l=4 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent4<T1, T2, A, R1, R2, R3, R4> SelectMany<T1, T2, _, A, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T1, T2, _, R1, R2, R3> source, Func<object, Result<R4>> secondSelector, Expression<Func<_, RelativeCell<R4>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent4<T1, T2, A, R1, R2, R3, R4>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        // n=3 k=2 l=2 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent2<T1, T2, T3, A, R1, R2> SelectMany<T1, T2, T3, _, A, R1, R2>(this IArrayQueryRecurrent<T1, T2, T3, _, R1> source, Func<object, Result<R2>> secondSelector, Expression<Func<_, RelativeCell<R2>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent2<T1, T2, T3, A, R1, R2>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform3<T1, T2, T3, R1, R2, R3> SelectMany<T1, T2, T3, _, R1, R2, R3>(this IArrayQueryRecurrent2<T1, T2, T3, _, R1, R2> source, Func<object, Result<R3>> recurrentSelector, Expression<Func<_, RelativeCell<R3>, (R1, R2, R3)>> resultSelector) 
            => new ArrayQuery3<T1, T2, T3, R1, R2, R3>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=3 k=3 l=3 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent3<T1, T2, T3, A, R1, R2, R3> SelectMany<T1, T2, T3, _, A, R1, R2, R3>(this IArrayQueryRecurrent2<T1, T2, T3, _, R1, R2> source, Func<object, Result<R3>> secondSelector, Expression<Func<_, RelativeCell<R3>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent3<T1, T2, T3, A, R1, R2, R3>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform4<T1, T2, T3, R1, R2, R3, R4> SelectMany<T1, T2, T3, _, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T1, T2, T3, _, R1, R2, R3> source, Func<object, Result<R4>> recurrentSelector, Expression<Func<_, RelativeCell<R4>, (R1, R2, R3, R4)>> resultSelector) 
            => new ArrayQuery4<T1, T2, T3, R1, R2, R3, R4>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=3 k=4 l=4 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent4<T1, T2, T3, A, R1, R2, R3, R4> SelectMany<T1, T2, T3, _, A, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T1, T2, T3, _, R1, R2, R3> source, Func<object, Result<R4>> secondSelector, Expression<Func<_, RelativeCell<R4>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent4<T1, T2, T3, A, R1, R2, R3, R4>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        // n=4 k=2 l=2 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent2<T1, T2, T3, T4, A, R1, R2> SelectMany<T1, T2, T3, T4, _, A, R1, R2>(this IArrayQueryRecurrent<T1, T2, T3, T4, _, R1> source, Func<object, Result<R2>> secondSelector, Expression<Func<_, RelativeCell<R2>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent2<T1, T2, T3, T4, A, R1, R2>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform3<T1, T2, T3, T4, R1, R2, R3> SelectMany<T1, T2, T3, T4, _, R1, R2, R3>(this IArrayQueryRecurrent2<T1, T2, T3, T4, _, R1, R2> source, Func<object, Result<R3>> recurrentSelector, Expression<Func<_, RelativeCell<R3>, (R1, R2, R3)>> resultSelector) 
            => new ArrayQuery3<T1, T2, T3, T4, R1, R2, R3>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=4 k=3 l=3 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent3<T1, T2, T3, T4, A, R1, R2, R3> SelectMany<T1, T2, T3, T4, _, A, R1, R2, R3>(this IArrayQueryRecurrent2<T1, T2, T3, T4, _, R1, R2> source, Func<object, Result<R3>> secondSelector, Expression<Func<_, RelativeCell<R3>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent3<T1, T2, T3, T4, A, R1, R2, R3>(source, secondSelector(default).InitValue, resultSelector);
...
///@@@
        ...
        public static IArrayTransform4<T1, T2, T3, T4, R1, R2, R3, R4> SelectMany<T1, T2, T3, T4, _, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T1, T2, T3, T4, _, R1, R2, R3> source, Func<object, Result<R4>> recurrentSelector, Expression<Func<_, RelativeCell<R4>, (R1, R2, R3, R4)>> resultSelector) 
            => new ArrayQuery4<T1, T2, T3, T4, R1, R2, R3, R4>(source, recurrentSelector(default).InitValue, resultSelector);
        // n=4 k=4 l=4 <T, _, A, R1, R2>

        public static IArrayQueryRecurrent4<T1, T2, T3, T4, A, R1, R2, R3, R4> SelectMany<T1, T2, T3, T4, _, A, R1, R2, R3, R4>(this IArrayQueryRecurrent3<T1, T2, T3, T4, _, R1, R2, R3> source, Func<object, Result<R4>> secondSelector, Expression<Func<_, RelativeCell<R4>, A>> resultSelector) 
            where A: class
            => new ArrayQueryRecurrent4<T1, T2, T3, T4, A, R1, R2, R3, R4>(source, secondSelector(default).InitValue, resultSelector);
