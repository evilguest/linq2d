...
namespace Linq2d
{
	public static partial class Array2d
	{
        ...
        public static IArrayTransform4<T1, T2, R1, R2, R3, R4> SelectMany<T1, T2, R1, R2, R3, R4>(this T1[,] source, Func<object, T2[,]> secondSelector, Expression<Func<Cell<T1>, Cell<T2>, (R1, R2, R3, R4)>> resultSelector) 
            => new ArrayQuery4<T1, T2, R1, R2, R3, R4>(source.Wrap(), secondSelector(default).Wrap(), resultSelector);

        public static IArrayTransform4<T1, T2, R1, R2, R3, R4> SelectMany<T1, T2, R1, R2, R3, R4>(this T1[,] source, Func<object, ArraySource<T2>> secondSelector, Expression<Func<Cell<T1>, Cell<T2>, (R1, R2, R3, R4)>> resultSelector) 
            => new ArrayQuery4<T1, T2, R1, R2, R3, R4>(source.Wrap(), secondSelector(default), resultSelector);
